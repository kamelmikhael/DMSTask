...
namespace DMSTask.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Index(string filter)
        {
            ...
            var applicationDbContext = _context.Customers.Include(c => c.User).AsQueryable();

            if(!string.IsNullOrWhiteSpace(filter))
            {
                applicationDbContext = applicationDbContext.Where(x =>
                    x.DescriptionAr!.Contains(filter) || 
        ...
        public async Task<IActionResult> Create([Bind("CustomerCode,DescriptionEn,DescriptionAr,UserId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerCode,DescriptionEn,DescriptionAr,UserId")] Customer customer)
        {
